...
const stews: Stew[] = [
  ...
  { id: 73, name: 'Fehérbabfőzelék tükörtojással', base: 'egy éjszakára beáztatott fehérbabot', topping: 'tükörtojással', cook: '60–80 percig', toppingStep: 'Kevés olajon süss négy tükörtojást, amíg a fehérje megszilárdul.', ingredients: [['fehérbab',500,'g'],['tojás',4,'db'],['tejföl',200,'ml'],['liszt',2,'ek'],['fokhagyma',2,'gerezd'],['babérlevél',2,'db'],['olaj',2,'ek'],['só',1,'tk']] },
  { id: 74, name: 'Cukkinifőzelék csirkefasírttal', base: 'lereszelt, enyhén sózott és kinyomkodott cukkinit', topping: 'csirkefasírttal', cook: '8–10 percig', toppingStep: 'A húst keverd össze tojással és morzsával, formázz pogácsákat, majd süsd teljesen át.', ingredients: [['cukkini',1000,'g'],['darált hús',500,'g'],['tojás',1,'db'],['zsemlemorzsa',80,'g'],['tejföl',200,'ml'],['liszt',2,'ek'],['kapor',0.5,'csokor'],['só',1,'tk']] },
  ...
  { id: 76, name: 'Brokkolifőzelék sajtos húspogácsával', base: 'rózsákra szedett brokkolit', topping: 'sajtos húspogácsával', cook: '8–10 percig', toppingStep: 'A húst keverd össze tojással és sajttal, formázz pogácsákat, majd süsd teljesen át.', ingredients: [['brokkoli',1000,'g'],['darált sertéshús',500,'g'],['reszelt sajt',120,'g'],['tojás',1,'db'],['tej',400,'ml'],['liszt',2,'ek'],['fokhagyma',2,'gerezd'],['só',1,'tk']] },
  ...
  { id: 80, name: 'Csicseriborsó-főzelék sült kolbásszal', base: 'leöblített csicseriborsót', topping: 'sült kolbásszal', cook: '12–15 percig', toppingStep: 'A kolbászt karikázd fel, és száraz serpenyőben süsd mindkét oldalán barnára.', ingredients: [['csicseriborsó konzerv',1000,'g'],['füstölt kolbász',350,'g'],['tejföl',200,'ml'],['liszt',2,'ek'],['fokhagyma',2,'gerezd'],['babérlevél',2,'db'],['pirospaprika',1,'tk'],['só',1,'tk']] },
  { id: 81, name: 'Vöröslencse-főzelék főtt tojással', base: 'átmosott vöröslencsét', topping: 'főtt tojással', cook: '18–20 percig', toppingStep: 'A tojásokat forrástól számítva 10 percig főzd, hűtsd le, hámozd meg és vágd félbe.', ingredients: [['vöröslencse',500,'g'],['tojás',4,'db'],['vöröshagyma',1,'db'],['fokhagyma',2,'gerezd'],['paradicsompüré',2,'ek'],['babérlevél',1,'db'],['olaj',2,'ek'],['só',1,'tk']] },
