...
const stews: Stew[] = [
  ...
  { id: 85, name: 'Tarkababfőzelék füstölt hússal', base: 'egy éjszakára beáztatott tarkababot', topping: 'füstölt hússal', cook: '60–90 percig', toppingStep: 'A füstölt csülköt kezdd főzni 60 perccel korábban, majd a babbal együtt főzd teljesen puhára.', ingredients: [['tarkabab',300,'g'],['füstölt csülök',700,'g'],['tejföl',200,'ml'],['liszt',2,'ek'],['fokhagyma',2,'gerezd'],['babérlevél',2,'db'],['pirospaprika',1,'tk'],['só',0.5,'tk']] },
  ...
  { id: 88, name: 'Lencsés burgonyafőzelék sült tarjával', base: 'átmosott lencsét és felkockázott burgonyát', topping: 'sült tarjával', cook: '35–45 percig', toppingStep: 'A sózott tarjaszeleteket serpenyőben süsd oldalanként 5–7 percig, majd pihentesd.', ingredients: [['lencse',250,'g'],['burgonya',600,'g'],['sertéstarja',700,'g'],['tejföl',180,'ml'],['liszt',2,'ek'],['babérlevél',2,'db'],['mustár',1,'ek'],['olaj',1,'ek'],['só',1,'tk']] },
  ...
  { id: 90, name: 'Vegyes zöldségfőzelék húsgombóccal', base: 'felkockázott sárgarépát, karalábét és zöldborsót', topping: 'húsgombóccal', cook: '30–35 percig', toppingStep: 'A húst keverd tojással, rizzsel és hagymával, nedves kézzel formázz gombócokat, és főzd át teljesen.', ingredients: [['sárgarépa',400,'g'],['karalábé',400,'g'],['zöldborsó',300,'g'],['darált sertéshús',500,'g'],['tojás',1,'db'],['rizs',80,'g'],['vöröshagyma',1,'db'],['tejföl',200,'ml'],['liszt',2,'ek'],['só',1,'tk']] },
];
