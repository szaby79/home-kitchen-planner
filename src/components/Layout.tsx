...
import { DayPlan, Recipe, WeekPlan, WeekDay, ShoppingItem, WeekendDessertMode, GenerationSelection, LunchGenerationOptions } from '@/types/recipe';
...
interface AppContextType {
  ...
  clearPlan: () => void;
  generateRandomPlan: (selection: GenerationSelection, dessertMode: WeekendDessertMode, lunchOptions: LunchGenerationOptions) => void;
    ...
    <AppContext.Provider value={ctx}>
      <div className="min-h-screen flex flex-col">
        ...
        <footer className="border-t border-[#E4C7AA] bg-[#FFF3E3] py-4 text-center text-xs text-muted-foreground">
          Plan & Pan v1.9 © {new Date().getFullYear()} — Magyar családi ételtervező
        </footer>
      </div>
    </AppContext.Provider>
  );
