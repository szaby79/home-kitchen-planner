...
interface AppContextType {
  ...
  clearPlan: () => void;
  generateRandomPlan: (selection: GenerationSelection, profile: MenuProfile, preferences: MenuPreferences, favoriteIds: string[]) => boolean;
    ...
    <AppContext.Provider value={ctx}>
      <div className="min-h-screen flex flex-col">
        ...
        <footer className="border-t border-[#E4C7AA] bg-[#FFF3E3] py-4 text-center text-xs text-muted-foreground">
          Plan & Pan v1.18 © {new Date().getFullYear()} — {tr('Magyar családi ételtervező', 'Hungarian family meal planner')}
        </footer>
      </div>
    </AppContext.Provider>
  );
